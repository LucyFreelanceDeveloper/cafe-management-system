-- Users
INSERT INTO "user" (contact_number,email,name,password,`role`,status) VALUES
...
-- Bills
INSERT INTO `bill` (contact_number,created_by,email,name,payment_method,product_detail,total,uuid) VALUES
